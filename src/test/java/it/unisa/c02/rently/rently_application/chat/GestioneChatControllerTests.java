...
public class GestioneChatControllerTests {
    ...
    @WithMockUser(username = "user1", roles = {"USER"})
     void testAggiungiMessaggio() throws Exception {
        ...
        final MessaggioDTO messaggioDTO = new MessaggioDTO();
        ...
        final Messaggio mockMessaggio = new Messaggio("Contenuto del messaggio", Timestamp.valueOf("2024-01-21 12:34:56"),mockUtente1,mockUtente2);
